...
Public Class frmSanPham
    ...
    Dim chuoiketnoi As String = "workstation id=SANPHAM1.mssql.somee.com;packet size=4096;user id=cuongmanh993_SQLLogin_1;pwd=uxqz2mjsni;data source=SANPHAM1.mssql.somee.com;persist security info=False;initial catalog=SANPHAM1"
